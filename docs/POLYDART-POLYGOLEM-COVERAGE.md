...
| internal/relayer | polygolem/internal/relayer | lib/src/relayer, lib/src/credentials | partial | test/relayer, test/credentials | required | 2b7cde7 | SIWE cookie login, Relayer V2 API-key minting, submit, auth headers, object/list transaction responses, and allowlist classification covered; continue deposit-wallet readiness consumption |
