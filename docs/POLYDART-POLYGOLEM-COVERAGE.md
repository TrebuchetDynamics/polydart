...
| Deposit-wallet live semantics | internal/wallet, internal/relayer, internal/clob | lib/src/wallet, lib/src/relayer, lib/src/clob, lib/src/credentials, lib/src/orders | partial | test/wallet, test/relayer, test/clob, test/credentials, test/orders | required | 2b7cde7 | Deposit-wallet readiness and limit-order placement now cover sigtype-3 approval/funding checks, ERC-7739 wrapped signing, deposit-wallet maker/signer fields, and EOA-bound CLOB HMAC auth; continue market-order/batch/cancel parity and pUSD routing |
